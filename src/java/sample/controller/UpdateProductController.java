...
public class UpdateProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO product = new ProductDTO(productID, productName, "", price, quantity, "", importDate);
            
            if(dao.updateProduct(product)){
                request.setAttribute("UPDATE_SUCCESS", "Update successfully product " + productID );
                url = SUCCESS;
            }else {
                request.setAttribute("UPDATE_ERROR", "Update fail!!");
            }
