    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (Game game : cart.getCart().values()) {
                String productID = game.getGameID();
                ProductDAO productDAO = new ProductDAO();
                int newQuantity = productDAO.getProductQuantity(productID) - game.getQuantity();
                productDAO.updateProductQuantity(productID, newQuantity);
                addNewOrderDetail = orderDAO.addNewOrderDetail(orderID, game);
            }
