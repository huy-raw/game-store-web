...
public class DeleteProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(check){
                url = SUCCESS;
                request.setAttribute("DELETE_SUCCESS", "Delete product " + productID + " successfully");
            }else {
                 request.setAttribute("DELETE_ERROR", "Delete product " + productID + " fail");
            }
        } catch (Exception e) {
            log("Error at DeleteProductController");
        } finally {
