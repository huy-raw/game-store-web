            ...
            <div class="rightPane">
                ...
                <div class='minicart'>
                    <div class='minicart--item-container'>
                        You have
                        <span class='minicart--item-count' style='font-weight: 600'><%=cart.getCartAmountGame()%> items</span>
                        in your cart!
                    </div>
                    ...
                    <ul>
                        ...
                        <li class='minicart--item'>
                            ...
                            <h1 class='title'><%=game.getGameName()%></h1>

                            <p class='price'><%= game.getPrice()%> ₫ (x<%=game.getQuantity()%>)</p>
                            <p class='remove'>
