            ...
            <div class="form-container sign-in-container">
                <form action="MainController" id="form" method="POST">
                    ...
                    <c:if test="${requestScope.ERROR_LOGIN != null}" >
                        <div class= "alert alert-danger" style="background-image: linear-gradient(to right, rgb(220, 58, 58) , rgb(225, 44, 44)); border-radius: 20px;  padding: 1.4px 6px; display: flex;align-items: center;">
                    ...
                    <c:if test="${requestScope.SUCCESS_SIGNUP != null}" >
                        <div class="  alert alert-success alert-light" style=" border-radius: 20px; padding: 1.4px 6px; display: flex;align-items: center; background-color: green">
                            <i class="fa fa-exclamation-circle " aria-hidden="true" style="color: white; margin-right: 4px;"></i>
                            ${requestScope.SUCCESS_SIGNUP}
                        </div>
                    </c:if>
